...
import type { TuningSuggestion } from '../agents/tuningAgent';
...
export class TuningService {
  private static instance: TuningService | null = null;
  private intervalId: ReturnType<typeof setInterval> | null = null;

  private constructor() {}

  static getInstance(): TuningService {
   ...
   */
  trackChirpView(chirpId: string): void {
    try {
   ...
   */
  trackChirpEngagement(chirpId: string): void {
    try {
   ...
   */
  private getViewedChirps(): string[] {
    try {
   ...
   */
  private getEngagedChirps(): string[] {
    try {
   ...
   */
  getLastSuggestion(): TuningSuggestion | null {
    try {
   ...
   */
  saveSuggestion(suggestion: TuningSuggestion): void {
    try {
   ...
   */
  async analyzeAndSuggest(): Promise<TuningSuggestion | null> {
    ...
    try {
      ...
      const behaviorData = TuningAgent.collectBehaviorData(
        currentUser,
        allChirps,
        viewedIds,
        engagedIds,
   ...
   */
  applySuggestion(suggestion: TuningSuggestion): void {
