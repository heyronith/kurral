// Agent-Assisted Reach Suggestions
// MVP: Uses simple heuristics (can be swapped for LLM later)
import type { TunedAudience, Topic } from '../types';
 ...
 */
export const suggestReachSettings = (
  text: string,
  topic: Topic
): ReachSuggestion => {
  ...
  const topicSuggestions: Record<Topic, Partial<TunedAudience>> = {
