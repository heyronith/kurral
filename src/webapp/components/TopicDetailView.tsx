    ...
    <div className="w-full">
      ...
      <div className="mb-6 pb-4 border-b border-border/60">
        <div className="flex items-center gap-4">
          <button
            ...
            className="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-backgroundElevated/60 transition-colors"
            aria-label="Back"
          >
          ...
          <div className="flex-1">
            <h1 className="text-2xl font-bold text-textPrimary">#{selectedTopic}</h1>
      ...
      {isLoading ? (
        <div className="py-12 text-center">
          <p className="text-textMuted">Loading posts...</p>
        </div>
      ) : topicPosts.length === 0 ? (
        <div className="py-12 text-center">
          <p className="text-textMuted">No posts found for this topic yet.</p>
          <p className="text-sm text-textMuted mt-2">Be the first to post about #{selectedTopic}!</p>
        </div>
      ) : (
