...
export const DashboardIcon = (props: Omit<IconFrameProps, 'children'>) => (
  <IconFrame {...props}>
...
// Moon/Dark mode icon
export const MoonIcon = (props: Omit<IconFrameProps, 'children'>) => (
  <IconFrame {...props}>
...
// Sun/Light mode icon
export const SunIcon = (props: Omit<IconFrameProps, 'children'>) => (
  <IconFrame {...props}>
