...
const LatestFeed = () => {
    ...
    if (chirps.length === 0) {
        return (_jsxs("div", { className: "p-8 text-center text-textMuted", children: [_jsx("p", { children: "No posts yet. Follow some users to see their posts here." }), _jsx("p", { className: "text-sm mt-2", children: "Because: Latest \u2013 pure chronological" })] }));
    }
